...
class Settings {
  ...
  //      wp_register_script('admin', plugin_dir_url( $this->pluginFile ) . '/js/rrze-video-admin.js', array('jquery'), false, true);
	...
	wp_enqueue_style('rrze-video-adminstyle');
        ...
        wp_register_script('rrze-video-wp-color-picker-settings', plugins_url('js/wp-color-picker.js', plugin_basename($this->pluginFile)));
        wp_register_script('rrze-video-wp-media-settings', plugins_url('js/wp-media.js', plugin_basename($this->pluginFile)));
    ...
    public function colorEnqueueScripts()  {
        ...
        wp_enqueue_script('rrze-video-wp-color-picker-settings');
    ...
    public function fileEnqueueScripts() {
        wp_enqueue_media();
        wp_enqueue_script('rrze-video-wp-media-settings');
        wp_enqueue_script('jquery');
    }
