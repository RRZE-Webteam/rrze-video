...
function taxonomy_genre() {
    ...
    $labels = array(
        ...
        'all_items'                   => __( 'Alle Genreen anzeigen', 'rrze-video' ),
        'parent_item'                 => __( 'Übergeordnete Genre', 'rrze-video' ),
        'parent_item_colon'           => __( 'Übergeordnete Genre', 'rrze-video' ),
        'new_item_name'               => __( 'Neue Genre', 'rrze-video' ),
        'add_new_item'                => __( 'Neue Genre hinzufügen', 'rrze-video' ),
