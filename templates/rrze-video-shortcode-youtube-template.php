...
<?php } ?>
    <div class="rrze-video-container rrze-video-id-<?php echo $box_id ?>">
        ...
        <a href="<?php echo $anchor; ?>" data-box-id="<?php echo $id ?>" data-youtube-id="<?php echo $youtube_id ?>" data-toggle="modal" data-target="#videoModal<?php echo $id ?>">
        <img title="<?php echo (!isset($modaltitle)) ? 'Youtube Image' : get_the_title() ?>" alt="Video aufrufen" class="image<?php echo $box_id ?>" src="<?php echo $preview_image; ?>" />
        <div class="middle">
    ...
    <div class="modal-content">
        ...
        <div class="modal-body">
            <div class="videocontent<?php echo $id ?>">
                ...
                <div class="player">
                      <img title="preview_image" width="100%" src="<?php echo $preview_image; ?>" alt="<?php echo $thistitle; ?>">
                </div>
                <?php } else { ?>
